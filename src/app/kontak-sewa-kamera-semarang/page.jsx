...
export default function ContactPage() {
  ...
  return (
    <div className="bg-white text-black min-h-dvh py-12 px-4 lg:pl-40 w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 border border-black p-4 md:p-8 bg-white">
        ...
        <div className="flex flex-col justify-between gap-4 border-t lg:border-t-0 lg:border-l border-black pt-8 lg:pt-0 lg:pl-8">
          <div className="flex flex-col gap-4">
            ...
            <div className="w-full h-64 md:h-80 border border-black relative bg-black/5 overflow-hidden">
              <iframe
                title="Google Maps Location"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.300729352125!2d110.4184!3d-6.9829!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e708b4ec0000001%3A0x1!2sSemarang!5e0!3m2!1sid!2sid!4v1700000000000!5m2!1sid!2sid"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen=""
