...
export default function MainSection() {
  return (
    <section className="relative w-full overflow-hidden bg-white flex flex-col items-center justify-center gap-8 px-4 py-16 h-[100dvh] lg:grid lg:grid-cols-3 lg:grid-rows-3 lg:gap-0 lg:p-0">
      ...
      <div className="order-2 w-full max-w-sm grid grid-cols-1 grid-rows-1 lg:order-none lg:max-w-none lg:row-start-1 lg:row-end-4 lg:col-start-3 lg:aspect-square lg:my-auto">
      ...
      <div className="order-1 relative z-40 w-full flex flex-col items-center gap-8 text-center lg:order-none lg:row-start-1 lg:row-end-4 lg:col-start-1 lg:col-end-3 lg:my-auto lg:items-start lg:justify-center lg:text-left lg:pl-56">
